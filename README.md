...
# アプリ概要
BODYCON は、日々の体重や摂取カロリー、運動内容を記録・管理できる laravel(バックエンドのみ)の体重管理アプリケーションです。
...
- 将来的に、フロントエンドとAPI連携でのSPA開発予定にて、「独自(アニマル)健康アプリ」としても、新規開発して実装していきたいと思います。
...
<img width="1217" height="677" alt="スクリーンショット (5911)" src="https://github.com/user-attachments/assets/d21035e1-c5d2-4743-afe2-284b8b17cf4e" />
...
「アニマル健康管理アプリ」に向け、健康履歴のための機能追加（カレンダーやグラフ）、管理画面の追加（owner）など開発予定。
